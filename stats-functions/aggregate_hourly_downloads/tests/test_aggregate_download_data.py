...
class TestAggregateHourlyDownloadsJob:
    ...
    def test_validate_cloud_event_valid(self):
        """Assert that AggregateHourlyDownloads._validate_cloud_event executes successfully when cloud event with valid timestamp is provided"""
    ...
    def test_validate_dates_valid(self):
        """Assert that AggregateHourlyDownloads._validate_dates executes successfully when valid start and end times are provided"""
